...
class SMA_StorageBoy(SMA_device):
    def __init__(self, ipAddress: str, port: str = ""):
        ...
        """
        super(SMA_StorageBoy, self).__init__(ipAddress, port)
    ...
    def _add_Modbus_registers(self):
        ...
        self.newRegister("ZählerstandEinspeisezähler", address=30583,
                         length=2, signed=False, type_="float", unit=" Wh")
        self.newRegister("Batteriestrom", address=30843,
                         length=2, signed=True, type_="float", unit=" A")
        self.newRegister("soc", address=30845, length=2,
                         signed=False, type_="float", unit=" %")
        self.newRegister("AktuelleBatteriekapazitaet", address=30847,
                         length=2, signed=False, type_="float", unit=" %")
        self.newRegister("Batterietemperatur", address=30849, length=2,
                         signed=True, factor=0.1, type_="float", unit=" °C")
        self.newRegister("Batteriespannung", address=30851, length=2,
                         signed=False, factor=0.01, type_="float", unit=" V")
        self.newRegister("MomentaneBatterieladung", address=31393,
                         length=2, signed=False, type_="float", unit=" W")
        self.newRegister("MomentaneBatterieentladung", address=31395,
                         length=2, signed=False, type_="float", unit=" W")
        self.newRegister("present_charge", address=31397,
                         length=4, signed=False, type_="float", unit=" Wh")
        self.newRegister("present_discharge", address=31401,
                         length=4, signed=False, type_="float", unit=" Wh")
        self.newRegister("UntereEntladegrenzeBeiEigenverbrauch",
                         address=40073, length=2, signed=False, type_="int", unit="")
        self.newRegister("BatterieStatus", address=34659,
                         length=2, signed=False, type_="int", unit="")
        self.newRegister("BatterieZustand", address=31391,
                         length=2, signed=False, type_="int", unit="")
        self.newRegister("BatterieBetriebsstatus", address=30955,
                         length=2, signed=False, type_="int", unit="")
        self.newRegister("BatterieNutzungsBereichStatus", address=31057,
                         length=2, signed=False, type_="int", unit="")
        self.newRegister("UntereGrenzeTiefenendladungVorAbschaltung",
                         address=40719, length=2, signed=False, type_="int", unit="")
        self.newRegister("MinimaleBreiteTiefenEntladeschutz",
                         address=40721, length=2, signed=False, type_="int", unit="")
        self.newRegister("BreiteErhaltungBatterieladezustand",
                         address=40725, length=2, signed=False, type_="int", unit=" %")
        self.newRegister("nomCapacity", address=40187, length=2,
                         signed=False, type_="int", unit=" Wh")
        self.newRegister("maxChargePower", address=40189,
                         length=2, signed=False, type_="int", unit=" W")
        self.newRegister("maxDischargePower", address=40191,
                         length=2, signed=False, type_="int", unit=" W")
        pass
